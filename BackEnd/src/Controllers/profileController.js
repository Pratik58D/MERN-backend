...
const UpdateProfile = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ msg: "Profile updated sucessfully ", profileUpdate, profile });
  } catch (err) {
    console.log(err);
...
const getProfiles = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ msg: "profile found sucessfully", profile: profile });
  } catch (err) {
    console.log(err);
...
const deleteProfile = async (req, res) => {
  try {
    ...
    return res
      .status(200)
      .json({ msg: "profile delete sucessfully", profile: profile });
  } catch (err) {
    console.log(err);
    return res.status(500).json({ msg: "Failed to retrieve profiles" });
  }
